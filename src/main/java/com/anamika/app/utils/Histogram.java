 ...
 * Copied from @see <a href="https://github.com/scalyr/iobench/blob/master/src/Histogram.java">scalyr/iobench/Histogram</a>
 */
public class Histogram {
     ...
     */
    public HistogramJsonOutput toJson() {
        ...
        HistogramJsonOutput.HistogramJsonOutputBuilder bldr = HistogramJsonOutput.builder();
        for (int i = firstNonzeroBucket; i <= lastNonzeroBucket; i++) {
            bldr.count(counts[i]);
        }

        HistogramJsonOutput histogramJsonOutput = bldr
                .pinMinimum(pinMinimum)
                .pinMaximum(pinMaximum)
                .bucketRatio(bucketRatio)
                .firstBucketStart(getBucketMin(firstNonzeroBucket))
